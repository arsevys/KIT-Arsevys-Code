...
namespace read_d2c_messages
{
    class ReadDeviceToCloudMessages
    {
        ...
        private readonly static string s_eventHubsCompatibleEndpoint = "sb://iothub-ns-123e-603911-99595c0750.servicebus.windows.net/";

        // Event Hub-compatible name
        // az iot hub show --query properties.eventHubEndpoints.events.path --name {your IoT Hub name}
        private readonly static string s_eventHubsCompatiblePath = "123e";
        
        // az iot hub policy show --name iothubowner --query primaryKey --hub-name {your IoT Hub name}
        private readonly static string s_iotHubSasKey = "4qRCam283E1I1mvRC1VDVGTgC4OYJuWT8few0lnQ1Ac=";
